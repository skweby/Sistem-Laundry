        ...
        <table>
            ...
            ?>
                <tr>
                    ...
                    <td><?= number_format($row['Berat_KG'] ?? 0, 1) ?> Kg</td>
    ...
    <div class="modal-box">
        ...
        <form method="POST">
            ...
            <div class="form-group">
                ...
                <input type="number" name="berat_kg" id="edit_berat" step="0.1" min="0" oninput="previewTotal()">
            </div>
            <div class="form-group">
